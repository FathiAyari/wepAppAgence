                     ...
                     child: DirectionMethode(controller: _controller,
                         ...
                         press:(currentPage == pages.length - 1 ) ?    (){
                           onboardingCach();
                            ...
                            onboardingCach();
                           _controller.nextPage(duration:const Duration(milliseconds: 300), curve: Curves.easeInOutQuint);}
...
class DirectionMethode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlatButton(onPressed: press,
      ...
      child: (currentPage == pages.length - 1 ) ? const Text('Commencer') : const Text('Suivant'),
